...
<div class="content">
    ...
    <form class="message" action="<%=request.getContextPath()%>/service/car/insert" enctype="multipart/form-data"
          method="post">
            ...
            <tr>
                ...
                <td>
                    <select name="carType" id="carType" style="width: 480px">
                        ...
                        <option value="皮车"> 皮车</option>
                        <option value="货车"> 货车</option>
                        <option value="MPV">商务车</option>
...
<script type="text/html" id="resultList">
    <form class="message" action="<%=request.getContextPath()%>/service/car/update" enctype="multipart/form-data"
          method="post">
        <table class="table table-bordered message_table">
            <tr>
                <td>上传图片</td>
                <td class="images-td">
                    <button type="button" class="btn btn-default upload-image">上传图片</button>
                </td>
            </tr>
            <tr>
                <td>商家名称：</td>
            ...
            <tr>
                <td>总数量：</td>
                <td><input type="number" name="carAmount" placeholder="请输入车辆数量" datatype="*"
                           value="{{result.carAmount}}">

                </td>
            </tr>
            <tr>
                <td>载人数：</td>
                <td><input type="number" name="carPeople" placeholder="请输入最大载人数" datatype="*"
                           value="{{result.carPeople}}">

                </td>
            </tr>
            <tr>
                <td>载货量：/吨</td>
                <td><input type="number" name="carGood" placeholder="请输入最大载货量/吨" datatype="*"
                           value="{{result.carGood}}">

                </td>
            </tr>
            <tr>
                <td>里程数：</td>
                <td><input type="number" name="carMilage" placeholder="请输入已跑里程数" datatype="*"
                           value="{{result.carMilage}}">
    ...
    <div class="images-show">
        ...
        <div class='image-par old-image-par' imagePath="{{image}}"><img class='car-images'
                                                                        src='<%=request.getContextPath()%>/skins/images/{{image}}'/><a
                onclick='deleteOldImage(this)'>删除</a></div>
        {{/each}}
    </div>
</script>
