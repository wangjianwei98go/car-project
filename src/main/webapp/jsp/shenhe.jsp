...
<jsp:include page="public/header.jsp"></jsp:include>
    <div class="content">
        ...
        <form class="message" action="<%=request.getContextPath()%>/service/order/insert1" enctype="multipart/form-data" method="post">
            <table class="table table-bordered message_table">
                ...
                <tr>
                    ...
                    <td>
                        <select name="carType" id="carType" style="width: 480px">
                            <option value="请选择车辆类型">请问题选择类型</option>
                            <option value="车辆破损" > 车辆破损</option>
                            <option value="交通事故" > 交通事故</option>
                            <option value="车辆正常" > 车辆正常</option>
                            </select>
                    </td>
                </tr>
                <tr>
                    <td>罚款价格：/元</td>
                    <td><input class="carPrice" type="text" name="carPrice" placeholder="请输入罚款价格" datatype="n">
                ...
                <tr>
                    <td>问题简述：</td>
                    <td>
                    <textarea class="car-info-textArea" name="carInfo" placeholder="请填写问题简述" datatype="*">
                    </textarea>
...
<script type="text/javascript" src="../skins/js/shenhe.js"></script>
</html>
